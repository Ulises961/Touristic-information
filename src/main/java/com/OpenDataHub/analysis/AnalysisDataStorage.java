...
public class AnalysisDataStorage {
  ...
  /**
   * list storing all relevant data for computing analysis
   */
  private static List<ActivityDescription> activitiesList;
...
//     //extract odhTags from all activities
...
//   public static RegionWithActivities getRegionWithMostActivities() {
...
//      return new RegionWithActivities(result);
//     }
...
//   public static RegionWithActivities getRegionWithLessActivities() {
...
//     }
   ...
   * @param newActivity
   */
  public static void addElement(ActivityDescription newActivity) {
    activitiesList.add(newActivity);
  }

  public static List<ActivityDescription> getList() {
